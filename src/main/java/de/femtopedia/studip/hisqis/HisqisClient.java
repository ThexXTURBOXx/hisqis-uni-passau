...
public class HisqisClient extends CustomAccessClient {
    ...
    public void authenticate(String username, String password)
        ...
        try (CustomAccessHttpResponse ignored = post("https://qisserver.uni-passau"
                + ".de/qisserver/rds?state=user&type=1&category=auth"
                + ".login&startpage=portal.vm&breadCrumbSource=portal", nvpms)) {
            this.asi = grabAsi();
     ...
     * @param headerVals An array containing values for the headers to send with the request (size must be the same as
     *                   headerKeys.length)
     ...
     */
    public CustomAccessHttpResponse get(String url, String[] headerKeys, String[] headerVals) throws IOException,
     ...
     * @throws IllegalAccessException   if the session isn't valid
     */
    public CustomAccessHttpResponse post(String url, String[] headerKeys, String[] headerVals, List<Pair<String,
            String>> nvps) throws IOException, IllegalArgumentException, IllegalAccessException {
        Request.Builder requestBuilder = new Request.Builder()
                .url(url);
     ...
     * @throws IllegalAccessException   if the session isn't valid
     */
    public CustomAccessHttpResponse put(String url, String[] headerKeys, String[] headerVals, List<Pair<String,
            String>> nvps) throws IOException, IllegalArgumentException, IllegalAccessException {
        Request.Builder requestBuilder = new Request.Builder()
                .url(url);
        return executeRequest(
     ...
     * @throws IllegalAccessException   if the session isn't valid
     */
    public CustomAccessHttpResponse delete(String url, String[] headerKeys, String[] headerVals, List<Pair<String,
            String>> nvps) throws IOException, IllegalArgumentException, IllegalAccessException {
        Request.Builder requestBuilder = new Request.Builder()
                .url(url);
        return executeRequest(
    ...
    public boolean isSessionValid() {
        return this.asi != null && !this.asi.isEmpty();
    }
