...
public class AsiParser {
	...
	private static final String ASI_URL = "https://qisserver.uni-passau.de/qisserver/rds?state=change&type=1&moduleParameter=studyPOSMenu&nextdir=change&next=menu.vm&subdir=applications&xml=menu&purge=y&navigationPosition=functions%2CstudyPOSMenu&breadcrumb=studyPOSMenu&topitem=functions&subitem=studyPOSMenu";
	...
	public String parse() throws IOException, IllegalArgumentException, IllegalAccessException, OAuthException {
		CustomAccessHttpResponse resp = client.get(ASI_URL);
